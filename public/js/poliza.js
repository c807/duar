...
function guardar_adjunto() {
	var formData;
	url_destino = "index.php/poliza/crear/guardar_adjunto";
...
function consulta_adjunto(doc) {
	...
	$.getJSON(url, { producto: doc.value }, function(data) {
...
function detalle_poliza() {
	...
	$.getJSON(url, { producto: dua.value }, function(data) {
...
function dowload_adjunto(pdf, ref) {
	...
	$.getJSON(url, { producto: pdf.value }, function(data) {});
}
