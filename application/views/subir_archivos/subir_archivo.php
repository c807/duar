                                ...
                                <div class="card-body text-center">
                                    <div>
                                        <?php if (isset($cantidad_productos)) {
                                            ...
                                            <a class="btn btn-primary" target="_blank" href="<?php echo base_url('index.php/subir_archivo/mostrar_clasificados')?>" role="button">Ir a Generación de Archivo Excel</a>
                                        <?php } else { ?>
