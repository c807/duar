...
<tr>
    ...
    <td>
        ...
        <a href='#crear_producto' onclick="mostrar(2)" class="btn btn-primary btn-xs" title="Editar Producto" data-id=""
            ...
            data-book-id18="<?php echo  $row->idestado ?>"
            data-book-id19="<?php echo  $row->idunidad ?>"
            data-book-id20="<?php echo  $row->pais_procedencia ?>"
        ...
        <a href='#borrar_producto' onclick="datos_borrar(3)" class="btn btn-default btn-xs" title="Eliminar"
            ...
            data-book-id2="<?php echo $row->producimport;?>">
        ...
        <a href='#verficha' onclick="mostrarficha()" class="btn btn-default btn-xs" title="Visualizar Ficha" data-id=""
            ...
            data-book-id15="<?php echo  $row->tipo_bulto ?>" data-book-id16="<?php echo  $row->paisorigen ?>"
            data-book-id17="<?php echo  $row->nombre_pais ?>" data-book-id18="<?php echo  $row->descripcion_bulto ?>"
